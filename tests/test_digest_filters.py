...
class TestExtractCorrectionsFiltering(unittest.TestCase):
    ...
    def test_explicit_corrections_start_pending(self):
        """Explicit corrections start pending under upstream's repetition gate."""
        messages = [
    ...
    def test_genuine_explicit_correction_is_pending(self):
        """Genuine explicit corrections are captured, then promoted by repetition."""
        messages = [
            make_assistant(0, "I ran ssh bike to connect."),
